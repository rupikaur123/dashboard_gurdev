...
export class StaticPagesComponent implements OnInit {
  ...
  edit() {
    const headers = { 'Authorization': 'Bearer ' + this.token }
    this.http.get<any>(this.baseUrl + 'api/static_pages/' + this.news_data.id + '/edit', { 'headers': headers })
      .subscribe(data => {
  ...
  update() {
    ...
    this.http.post<any>(this.baseUrl + 'api/static_pages/' + this.news_data.id, formdata, { 'headers': headers })
      .subscribe(
        response => {
          this.data = response
          console.log("Data" + this.data);
